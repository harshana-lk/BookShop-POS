...
public class CustomerManagePanelController {
    ...
    private final CustomerBO customerBO = (CustomerBO) BOFactory.getInstance().getBO(BOTypes.CUSTOMER);
    ...
    public boolean validate() {
        return !(txtID.getText().isEmpty() || txtName.getText().isEmpty() || txtNIC.getText().isEmpty() || txtAddress.getText().isEmpty() || txtPhone.getText().isEmpty());
    }
...
//            }
            ...
            String customerIDs = customerBO.setCustomerIDs();
            txtID.setText(customerIDs);
...
//                });
//            }
            ObservableList<CustomerTm> customerTms = customerBO.customerFunctions(searchText);
